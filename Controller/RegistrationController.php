...
class RegistrationController extends AbstractController
{
     ...
     */
    public function register(Request $request, UserPasswordEncoderInterface $passwordEncoder, GuardAuthenticatorHandler $guardHandler, BisonLabUserAuthenticator $authenticator): Response
    {
        $user = new User();
